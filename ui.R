...
shinyUI(fluidPage(
  sidebarLayout(
    sidebarPanel(width=6,
                 ...
                 tags$div(`data-value` = "test",tags$img(src="https://s3.console.aws.amazon.com/s3/buckets/forcogimage?region=ap-south-1/cogent_monogram.png",width="43px" , height= "43px", align="left"),
